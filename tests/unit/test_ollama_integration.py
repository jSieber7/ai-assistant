...
from app.core.config import OllamaSettings, Settings
...
class TestOllamaProvider:
    ...
    async def test_ollama_health_check_failure(self):
        ...
        with patch('httpx.AsyncClient') as mock_client:
            ...
            assert result == False
            assert provider.is_healthy() == False
...
class TestLLMProviderRegistry:
    ...
    def test_register_multiple_providers(self):
        ...
        assert registry._default_provider == ProviderType.OLLAMA  # First registered becomes default
    ...
    async def test_health_check_all(self):
        ...
        assert ollama_provider.is_healthy() == True
        assert openrouter_provider.is_healthy() == True
...
class TestOllamaSettings:
    ...
    def test_ollama_settings_defaults(self):
        ...
        assert settings.streaming == True
        assert settings.health_check_interval == 60
        assert settings.auto_health_check == True
    ...
    def test_ollama_settings_custom_values(self):
        ...
        assert settings.streaming == False
...
class TestModelInfo:
    ...
    def test_model_info_optional_fields(self):
        ...
        assert model.supports_streaming == True  # Default
        assert model.supports_tools == True  # Default