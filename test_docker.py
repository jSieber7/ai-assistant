...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test Docker integration for AI Assistant")
    parser.add_argument("--start", action="store_true", help="Start services before testing")
    parser.add_argument("--stop", action="store_true", help="Stop services after testing")
