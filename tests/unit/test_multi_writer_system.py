...
from app.core.config.multi_writer_config import MultiWriterSettings, validate_multi_writer_config
...
class TestMultiWriterSettings:
    ...
    def test_default_settings(self):
        ...
        assert settings.enabled == False  # Disabled by default
    ...
    def test_validate_config_disabled(self):
        ...
        with patch('app.core.config.multi_writer_config.multi_writer_settings', settings):
...
class TestMultiCheckerOrchestrator:
    ...
    def test_select_best_version(self, orchestrator):
        ...
        checks = [
            {"score": 70, "improved_content": "Content A", "checker_id": "checker1", "focus_area": "style"},
            {"score": 85, "improved_content": "Content B", "checker_id": "checker2", "focus_area": "factual"},
            {"score": 75, "improved_content": "Content C", "checker_id": "checker3", "focus_area": "structure"}
        ]
...
class TestJinjaProcessor:
    ...
    def test_generate_metadata(self, processor):
        ...
        assert metadata["has_links"] == True
