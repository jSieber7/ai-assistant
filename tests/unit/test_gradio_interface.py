...
class TestGradioInterface:
    ...
    def test_gradio_app_import(self):
        ...
        assert create_gradio_app is not None, "Failed to import create_gradio_app function"
    ...
    def test_gradio_mount_function_import(self):
        ...
        assert mount_gradio_app is not None, "Failed to import mount_gradio_app function"
    ...
    def test_gradio_dependency_installed(self):
        ...
        try:
            ...
            assert hasattr(gr, 'mount_gradio_app'), "Gradio mount_gradio_app function not found"
        except ImportError:
    ...
    def test_gradio_app_creation(self, mock_settings, mock_tool_registry, mock_provider_registry, mock_get_models):
    ...
    @patch('app.ui.gradio_app.tool_registry')
    @patch('app.ui.gradio_app.settings')
    def test_gradio_mount_function(self, mock_settings, mock_tool_registry, mock_provider_registry, mock_get_models):
